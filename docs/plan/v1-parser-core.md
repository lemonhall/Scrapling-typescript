...
- 2026-03-08 当前已交付：文本查找、正则查找、XPath 基线、父子兄弟祖先导航、`TextHandler`、`AttributesHandler` 高级语义、selector generation
- selector list 包装、pseudo text、similar elements 等更完整 parity 继续留在 parser-core 后续切片
